...
function buildRows(cityName: string): BenchmarkRow[] {
  return [
    {
      source: "gios",
    ...
    },
    {
      ...
      desc_pl: `${cityName} już teraz przekracza ten limit.`,
      desc_en: `${cityName} already exceeds this limit.`,
      color: "#EF9F27",
    },
    {
      source: "eu_directive",
    ...
    },
    {
      ...
      desc_pl: `Poziom, przy którym powietrze jest naprawdę bezpieczne. ${cityName} jest powyżej tej wartości.`,
      desc_en: `The level at which air is genuinely safe. ${cityName} is above this value.`,
      color: "#1D9E75",
    },
  ];
}

export default function ComplianceModal({ isOpen, onClose, lang, cityName }: Props) {
  const isKrakow = cityName === "Kraków";
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ fontSize: 15, fontWeight: 500, color: "var(--color-text-primary)", lineHeight: 1.35 }}>
            {lang === "pl"
              ? `${cityName} a normy jakości powietrza`
              : `${cityName} and air quality standards`}
          </div>
        ...
        <div style={{ padding: "16px 20px" }}>
          ...
          {/* Boiler fact — Poland-wide stat; Kraków ban sentence only for Kraków */}
          <div style={{
            ...
            {isKrakow
              ...
              : (lang === "pl" ? " — nie z ruchu drogowego." : " — not from traffic.")}
          </div>
